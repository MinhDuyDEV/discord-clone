      ...
      <DropdownMenuContent className="w-56 space-y-0.5 text-xs font-medium text-black dark:text-neutral-400 ">
        ...
        {isAdmin && (
          <DropdownMenuItem
            ...
            className="flex px-3 py-2 text-sm cursor-pointer hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50"
          >
            Server Settings
        ...
        {isAdmin && (
          <DropdownMenuItem className="flex px-3 py-2 text-sm cursor-pointer hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50">
            Manage Members
        ...
        {isAdmin && (
          <DropdownMenuItem className="flex px-3 py-2 text-sm cursor-pointer hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 text-rose-500">
            Delete server
